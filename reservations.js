...
require.register("reservation-form.js/confirm.js", function(exports, require, module){
module.exports = '<div id="perfect-res-confirm">\n  <h3>Confirm Reservation</h3>\n  <p>Confirm that you would like to create a reservation for <span class="name"></span> with party of <span class="party-size"></span> on <span class="date"></span> at <span class="time"></span>. You will not be able to create another reservation at this restaurant on this date.</p>\n  <button id="perfect-res-confirm-button">Confirm Reservation</button>\n  <button id="perfect-res-go-back">Go Back</button>\n</div>';
});
require.register("reservation-form.js/form.js", function(exports, require, module){
module.exports = '<form action="#">\n  <fieldset>\n    <legend>Create a Reservation</legend>\n    <div id="perfect-res-form-alert" class="perfect-input-group"></div>\n    <div id="perfect-res-name" class="perfect-input-group">\n      <label for="name">Name</label>\n      <input type="text" name="name" maxlength="40" required autofocus>\n    </div>\n    <div id="perfect-res-phone" class="perfect-input-group">\n      <label for="phone">Phone</label>\n      <input type="tel" name="phone" maxlength="10" required>\n      <span>Phone must be able to receive SMS messages.</span>\n    </div>\n    <div id="perfect-res-email" class="perfect-input-group">\n      <label for="email">Email</label>\n      <input type="email" name="email" maxlength="50" required>\n    </div>\n    <div id="perfect-res-date" class="perfect-input-group">\n      <label for="date">Date</label>\n      <input type="date" name="date" required>\n    </div>\n    <div id="perfect-res-party-size" class="perfect-input-group">\n      <label for="party-size">Party Size</label>\n      <select name="party-size">\n        <option value="0" selected="true">Select Size</option>\n      </select>\n    </div>\n    <div id="perfect-res-time" class="perfect-input-group">\n      <label for="time">Time</label>\n      <select name="time" disabled="true"></select>\n    </div>\n    <div id="perfect-res-buttons" class="perfect-input-group">\n      <input type="submit" value="Make Reservation" disabled="true">\n    </div>\n  </fieldset>\n</form>';
});
require.register("reservation-form.js/success.js", function(exports, require, module){
module.exports = '<div id="perfect-res-success">\n  <h3>Reservation Confirmed</h3>\n  <p>Your reservation for a party of <span class="party-size"></span> on <span class="date"></span> at <span class="time"></span> has been created. You will receive a confirmation text shortly.</p>\n  <p>We look forward to seeing you then!</p>\n</div>';
});
require.alias("component-jquery/index.js", "reservation-form.js/deps/jquery/index.js");
